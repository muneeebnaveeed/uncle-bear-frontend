                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="card-title-desc">
                                            ...
                                            button. For proper styling, for Example, <strong>color = </strong>{' '}
                                    ...
                                    <CardBody>
                                        ...
                                        <div className="">
                                            <UncontrolledAlert
                                                ...
                                                role="alert"
                                            >
                                                <i className="mdi mdi-bullseye-arrow mr-2" />A simple primary
                                                alert—check it out!
                                            </UncontrolledAlert>
                                            <UncontrolledAlert
                                                color="secondary"
                                            ...
                                            <UncontrolledAlert
                                                ...
                                                role="alert"
                                            >
                                                <i className="mdi mdi-check-all mr-2" />A simple success alert—check it
                                                out!
                                            </UncontrolledAlert>
                                            <UncontrolledAlert
                                                color="danger"
                                            ...
                                            <UncontrolledAlert
                                                ...
                                                role="alert"
                                            >
                                                <i className="mdi mdi-alert-circle-outline mr-2" />A simple info
                                                alert—check it out!
                                            </UncontrolledAlert>
                                        </div>
                                    </CardBody>
