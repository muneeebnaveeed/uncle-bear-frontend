...
class FormAdvanced extends Component {
    ...
    threshholdchange(event) {
        ...
        const remain_val = this.state.max_len - 20;
        if (remain_val <= count) {
                            ...
                            <Col lg="6">
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="card-title-desc">
                                            This plugin integrates by default with Twitter bootstrap using badges to
                                            display the maximum lenght of the field where the user is inserting text.{' '}
                                        </p>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="text-muted m-b-15">
                                                Please note: if the <code>alwaysShow</code> option isenabled, the{' '}
                                            ...
                                            {this.state.disbadge ? (
                                                <span className="badgecount">
                                                    <span className="badge badge-success">
                                                        You Typed {this.state.optioncount} out of 25 chars available.
                                                    </span>
                                                </span>
                                            ) : null}
                                        </div>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="text-muted m-b-15">
                                                ...
                                                one of those strings. If none is specified, the positioning will be
                                                defauted to 'bottom'.
                                            </p>
                                            <Input
                                                type="text"
                                            ...
                                            {this.state.placementbadge ? (
                                                <span
                                                    style={{ float: 'right' }}
                                                    className="badgecount badge badge-info"
                                                >
