                    ...
                    <ul className="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="ecommerce-product-detail">{this.props.t('Product Detail')}</Link>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="auth-recoverpw">{this.props.t('Recover Password')}</Link>
                                </li>
                                <li>
                                    <Link to="auth-lock-screen">{this.props.t('Lock Screen')}</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="pages-maintenance">{this.props.t('Maintenance')}</Link>
                                </li>
                                <li>
                                    <Link to="pages-comingsoon">{this.props.t('Coming Soon')}</Link>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="form-advanced">{this.props.t('Advanced Plugins')}</Link>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="tables-datatable">{this.props.t('Data Tables')}</Link>
                                </li>
                                <li>
                                    <Link to="tables-responsive">{this.props.t('Responsive Table')}</Link>
                                </li>
                                <li>
                                    <Link to="tables-editable">{this.props.t('Editable Table')}</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul className="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <Link to="icons-materialdesign">{this.props.t('Material Design')}</Link>
                                </li>
                                <li>
                                    <Link to="icons-dripicons">{this.props.t('Dripicons')}</Link>
                                </li>
                                <li>
                                    <Link to="icons-fontawesome">{this.props.t('Font awesome 5')}</Link>
                                </li>
                            </ul>
                        </li>
