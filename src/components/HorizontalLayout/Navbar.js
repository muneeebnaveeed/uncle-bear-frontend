                                ...
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/">
                                            <i className="ri-dashboard-line mr-2" /> {this.props.t('Dashboard')}
                                        </Link>
                                    </li>
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        >
                                            ...
                                            {this.props.t('UI Elements')} <div className="arrow-down" />
                                        </Link>
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link
                                            ...
                                            role="button"
                                        >
                                            <i className="ri-apps-2-line mr-2" />
                                            {this.props.t('Apps')} <div className="arrow-down" />
                                        </Link>
                                        <div
                                            className={classname('dropdown-menu', { show: this.state.appState })}
                                        ...
                                        >
                                            ...
                                            <div className="dropdown">
                                                <Link
                                                    ...
                                                    role="button"
                                                >
                                                    {this.props.t('Ecommerce')} <div className="arrow-down" />
                                                </Link>
                                                <div
                                                    className={classname('dropdown-menu', {
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link
                                            ...
                                            role="button"
                                        >
                                            <i className="ri-stack-line mr-2" />
                                            {this.props.t('Components')} <div className="arrow-down" />
                                        </Link>
                                        <div
                                            className={classname('dropdown-menu', { show: this.state.componentState })}
                                        ...
                                        >
                                            ...
                                            <div className="dropdown">
                                                <Link
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    {this.props.t('Charts')} <div className="arrow-down" />
                                                </Link>
                                                <div
                                                    className={classname('dropdown-menu', {
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link
                                            ...
                                            aria-expanded="false"
                                        >
                                            <i className="ri-file-copy-2-line mr-2" />
                                            {this.props.t('Pages')} <div className="arrow-down" />
                                        </Link>
                                        <div
                                            className={classname('dropdown-menu', { show: this.state.extraState })}
                                        ...
                                        >
                                            <div className="dropdown">
                                                <Link
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    {this.props.t('Authentication')} <div className="arrow-down" />
                                                </Link>
                                                <div
                                                    className={classname('dropdown-menu', {
                                            ...
                                            <div className="dropdown">
                                                <Link
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    {this.props.t('Utility')} <div className="arrow-down" />
                                                </Link>
                                                <div
                                                    className={classname('dropdown-menu', {
